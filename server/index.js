...
io.on('connection', (socket) => {
  ...
  socket.on('safe', ({ actingTeamId }) => handle(() => game.safe(actingTeamId)));
  socket.on('breakSafe', ({ actingTeamId, targetTeamId }) => handle(() => game.breakSafe(actingTeamId, targetTeamId)));
  ...
  socket.on('removeSafe', ({ teamId }) => handle(() => game.removeSafe(teamId)));
